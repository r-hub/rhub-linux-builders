...
./build-image.sh debian-gcc-devel   --no-cache || true
./build-image.sh debian-gcc-release            || true
./build-image.sh debian-gcc-patched --no-cache || true

./build-image.sh fedora-clang                  || true
./build-image.sh fedora-clang-devel --no-cache || true
./build-image.sh fedora-gcc                    || true
./build-image.sh fedora-gcc-devel   --no-cache || true
...
./build-image.sh ubuntu-gcc-devel   --no-cache || true
./build-image.sh ubuntu-gcc-release            || true

./build-image.sh rocker-gcc-san     --no-cache || true
